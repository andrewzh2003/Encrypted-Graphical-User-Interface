...
class Body(tk.Frame):
    ...
    def set_posts(self, posts:list):
        ...
        # widget.
        self._posts = posts
        for p in range(len(self._posts)):
            self._insert_post_tree(p, self._posts[p])
...
class MainApp(tk.Frame):
    ...
    def publish(self, post):
        ds_client.send('168.235.86.101', 3021, self._current_profile.username, self._current_profile.password, post.entry, self._current_profile, self._current_profile.bio)
